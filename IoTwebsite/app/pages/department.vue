...
<template>
  <div class="bg-[#FFFDF9] font-sans text-[#2D3142]">
    ...
    <section
      ref="contentSection"
      class="min-h-screen py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto bg-[#FFFDF9]"
    >
      <div
        v-if="activeTab === 'iot'"
      ...
      >
        <div class="text-center mb-16">
          ...
          <p class="text-base text-gray-500 mt-3 font-medium">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto mb-24">
          <div
            ...
            :key="member.id"
            class="bg-[#F6F5F2] rounded-[2rem] p-8 flex flex-col items-center text-center shadow-sm hover:shadow-md transition-all duration-300"
          >
        ...
        <div class="flex flex-wrap justify-center gap-8 max-w-4xl mx-auto">
          <div
            ...
            :key="staff.id"
            class="bg-[#F6F5F2] rounded-[2rem] p-8 flex flex-col items-center text-center w-full sm:w-[calc(50%-1rem)] lg:w-[350px] shadow-sm hover:shadow-md transition-all duration-300"
          >
